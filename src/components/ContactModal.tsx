          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <textarea
                id="message"
                rows={4}
                className={`w-full px-3 py-2 border ${errors.message ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium text-white rounded-md transition-colors ${isFormValid ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-400 cursor-not-allowed'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
              >
                Send
              </button>
            </div>
